...
INSERT INTO rfai_stake (request_id, stake_member, stake_amount, claim_back_amount, created_at, row_created, row_updated)
VALUES(1, '0x95cED938F7991cd0dFcb48F0a06a40FA1aF46EBC', 100, 60, str_to_date('2019-11-04 17:34:28', '%Y-%m-%d %H:%i:%s'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO fund_request_transaction (stake_member, transaction_hash, created_at, row_created, row_updated) VALUES('0x95cED938F7991cd0dFcb48F0a06a40FA1aF46EBC', '0xbfd83e85caa0942e1cd5497e9fb4902e7f1a853f8d6eda33823603067b88c38f', str_to_date('2019-11-04 17:34:28', '%Y-%m-%d %H:%i:%s'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO rfai_stake (request_id, stake_member, stake_amount, claim_back_amount, created_at, row_created, row_updated)
VALUES(1, '0x3E5e9111Ae8eB78Fe1CC3bb8915d5D461F3Ef9A9', 150, 90, str_to_date('2019-11-04 17:34:28', '%Y-%m-%d %H:%i:%s'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO fund_request_transaction (stake_member, transaction_hash, created_at, row_created, row_updated) VALUES('0x3E5e9111Ae8eB78Fe1CC3bb8915d5D461F3Ef9A9', '0xafd83e85caa0942e1cd5497e9fb4902e7f1a853f8d6eda33823603067b88c38f', str_to_date('2019-11-04 17:34:28', '%Y-%m-%d %H:%i:%s'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
