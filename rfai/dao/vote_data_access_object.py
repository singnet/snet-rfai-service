...
class VoteDAO:
    ...
    def add_vote(self, request_id, voter_solution, rfai_solution_id, created_at):
        query_response = self.repo.execute(
            "INSERT INTO rfai_vote (request_id, voter_solution, rfai_solution_id, created_at, "
            "row_created, row_updated) "
            "VALUES (%s, %s, %s, %s, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)",
            [request_id, voter_solution, rfai_solution_id, created_at])
